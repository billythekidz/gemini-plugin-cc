...
| Scope validation (`--scope` flag) | [Known bug #1](https://github.com/billythekidz/gemini-plugin-cc/issues/1) — falls through to default silently |
| Protocol method mismatch edge cases | [Known bug #2](https://github.com/billythekidz/gemini-plugin-cc/issues/2) |
